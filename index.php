                ...
                <form method="post" action="./insert.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="gender" id="exampleFormControlSelect1">
                            ...
                            <option value="nonbinary">Preferisco non specificarlo</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckChecked">Accetto la privacy</label>
                    </div>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" required>
                        <label class="form-check-label" for="flexSwitchCheckChecked">Accetto le condizioni di
                            utilizzo</label>
                    </div>
                    <div class="form-group">
                        <label for="card">Numero tessera</label>
                        <input type="number" name="ntessera" class="form-control"
                            placeholder="Inserisci il numero della tua tessera" required>
                    </div>
                    <div class="container button">
                        <button id="bottone" type="submit"
                            class="btn btn-primary hover card-title without-border">Iscriviti</button>
                    </div>
                </form>
            </div>
        </div>
