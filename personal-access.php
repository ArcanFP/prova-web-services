        ...
        <div class="card opacity without-border">
            ...
            ?>
                    <div class="card-body card-background">
                        <p>Ciao <br><?php echo $row['nome']; ?> <?php echo $row['cognome']; ?>.
                            <br>Hai ancora <br><strong><?php echo $row['accessi']; ?> accessi </strong>
                        </p>
                        <br>
                    </div>
                    <div class="card-body card-background">
                        <form method="post" action="./update-accessi.php">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            <input type="number" min="0" name="accessi" placeholder="Inserisci gli accessi da aggiungere">
                            <div class="container button">
                                <button id="bottone" type="submit" class="btn btn-primary hover card-title without-border">Aggiungi accessi</button>
                            </div>
                        </form>
                    </div>
                <?php
