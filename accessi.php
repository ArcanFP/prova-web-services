    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card opacity without-border">
            ...
            <div class="card-body card-background">
                <form method="post" action="./personal-access.php">
                    <div class="form-group">
                        <label for="ntessera">Inserisci il numero della tua tessera</label>
                        <input type="number" id="focus" name="ntessera" class="form-control" placeholder="Inserisci il numero della tua tessera">
                    </div>
                    <div class="form-group">
                        <label for="ntessera">Inserisci la tua email</label>
                        <input type="email" name="email" class="form-control" placeholder="Inserisci la tua email">
                    </div>
                    <div class="form-group button">
                        <button id="bottone" class="btn btn-primary hover card-title without-border" type="submit" class="btn btn-primary">Verifica i tuoi accessi</button>
                    </div>
                </form>
            </div>
        </div>
